...
// March 14, 2026 11:00 AM EST = 15:00 UTC (DST active, EDT = UTC-4)
const EVENT_DATE = "2026-03-14T15:00:00Z";

const GlobalAISummitHero: React.FC = () => {
    ...
    <section className="relative py-20 md:py-24 px-6 flex flex-col items-center justify-center text-center bg-paper overflow-hidden">
      ...
      <div className="relative group z-10 flex flex-col items-center gap-6">
        ...
        {eventEnded ? (
          ...
          <>
            <a href="https://luma.com/d72x6b4o" target="_blank" rel="noreferrer" className="relative px-8 md:px-12 py-4 md:py-5 bg-ink text-paper font-mono uppercase text-base md:text-lg border border-ink hover:bg-paper hover:text-ink transition-all duration-0 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] hover:translate-x-[2px] hover:translate-y-[2px] hover:shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] inline-block">
              Reserve Seat
            </a>
...
export default GlobalAISummitHero;
