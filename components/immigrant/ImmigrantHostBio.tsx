...
const ImmigrantHostBio: React.FC = () => {
  return (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2">
            ...
            <div className="p-8 md:p-10 flex flex-col justify-center bg-paper">
                ...
                <div className="font-serif text-base md:text-lg leading-relaxed space-y-4 mb-8 max-w-md">
                    <p>
                        Hari Prasad is an Ivy League alum and ex-immigrant founder who spent time on OPT, didn't get an H1B in all three attempts, and moved to the UK on a skilled worker visa.
                    </p>
                    <p>
                        Having experienced the uncertainty of the visa lottery system firsthand, he understands the pain that immigrants go through while getting a job, navigating visas, and going through this entire process.
                    </p>
                    <p>
                        This event is his contribution to the immigrant community—bringing together people who can share the right path and strategy for navigating these challenges and building successful careers.
                    </p>
                </div>
...
export default ImmigrantHostBio;
